  ...
  $.fn.higooglefonts = function (options) {
    ...
    this.on("select2:select", function (e) {
      ...
      if (typeof settings.selectedCallback == "function") {
        ...
        settings.selectedCallback.call(this, e.params.data.text);
      }
